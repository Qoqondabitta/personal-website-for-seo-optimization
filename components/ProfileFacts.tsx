...
const facts: Fact[] = [
  ...
  { icon: Bike, label: "Business", value: "E-bike Rental", badge: "International Business" },
...
export default function ProfileFacts() {
  return (
    <div className="rounded-2xl border border-white/10 glass shadow-2xl shadow-black/50 p-6 md:p-8">
